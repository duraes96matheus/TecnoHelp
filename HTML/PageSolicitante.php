...
<html lang="pt-br">
	...
	<?php 
		...
		<META HTTP-EQUIV=REFRESH CONTENT = '4;Index.php'>
			<script>
				swal({
				  title: 'Você não é um Solicitante!',
				  icon: 'error',
				  button: 'OK!',
			});				
		</script> ";			
	...
	<head>		
		...
		<link href="CSS/styleindexsolicitante.css" type="text/css" rel="stylesheet">
			...
			<div id="all" align="center">
				<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<a class="nav-link" href="#">Seja bem vindo(a) <?php echo $dados['name']; ?> <span class="sr-only">(current)</span></a>
						</li>
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="HistoricoAtivo.php">Ativas</a>		                  
						</div>
					</li>  			     
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
